...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // NAB Brand Colors - Enterprise Grade
        'nab-red': {
          50: '#fff0f0',
          100: '#ffdddd',
          200: '#ffc0c0',
      ...
      boxShadow: {
        'nab': '0 4px 6px -1px rgba(213, 0, 0, 0.1), 0 2px 4px -1px rgba(213, 0, 0, 0.06)',
        'nab-lg': '0 10px 15px -3px rgba(213, 0, 0, 0.1), 0 4px 6px -2px rgba(213, 0, 0, 0.05)',
        'inner-nab': 'inset 0 2px 4px 0 rgba(213, 0, 0, 0.06)',
      },
      screens: {
        'xs': '475px',
        '3xl': '1600px',
